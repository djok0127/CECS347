...
int main(void){
  ...
  PWM1B_Init(16000, 8000);         // initialize PWM0, 1000 Hz, 25% duty
//  PWM0A_Duty(4000);    // 10%
//  PWM0A_Duty(10000);   // 25%
//  PWM0A_Duty(30000);   // 75%
//  PWM0B_Duty(4000);    // 10%
...
void GPIOPortF_Handler(void){ // called on touch of either SW1 or SW2
  ...
  H = 16000-L; // constant period of 1ms, variable duty cycle
		
	PWM1B_Duty(H);
	
	GPIO_PORTF_ICR_R = 0x11;  // acknowledge flag0 and 4
}
